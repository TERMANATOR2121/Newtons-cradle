...
ground.shapecolor(50, 50, 50);

bobObject1=new Bob(300,350,50);
bobObject1.shapecolor(128,0,128);
bobObject2=new Bob(350,350,50);
bobObject2.shapecolor(128,0,128);
bobObject3=new Bob(400,350,50);
bobObject3.shapecolor(128,0,128);
bobObject4=new Bob(450,350,50);
bobObject4.shapecolor(128,0,128);
bobObject5=new Bob(500,350,50);
bobObject5.shapecolor(128,0,128);
